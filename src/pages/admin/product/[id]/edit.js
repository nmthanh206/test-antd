...
const ProductEditScreen = () => {
   ...
   useEffect(() => {
      ...
      const url = `https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload/v1630670794/${productDetail?.image}`;

      if (productDetail)
         setFileList([
            ...fileList,
            {
               uid: productDetail._id,
   ...
   if (isLoadingProductDetails || isLoadingUpdateProduct)
      return (
         <div className="-mt-44">
            <Loader />
         </div>
