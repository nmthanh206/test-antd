  ...
  const columns = [
...

    {
      ...
      render: (_, rowIndex) => {
        return (
          <Space size={30}>
            <Link to={`/admin/product/${rowIndex._id}/edit`}>
    ...
    <Row>
      <Col span={4} offset={20} className="">
        <Link
          ...
          className=" px-5 py-2 inline-block -mr-10 text-white hover:text-white rounded-3xl"
      ...
      <Col
        span={20}
        offset={2}
        className=" border-solid border-2 border-gray-100 shadow-lg pr-2 mt-6"
      >
        <Table
          columns={columns}
